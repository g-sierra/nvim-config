    ...
    config = function()
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("grr", vim.lsp.buf.references, "List all References")
          ...
          map("gO", vim.lsp.buf.document_symbol, "List all Document Symbols")
          map("gW", vim.lsp.buf.workspace_symbol, "List all Workspace Symbols")
